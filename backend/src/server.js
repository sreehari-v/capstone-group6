...
import stepTrackingRoutes from "./routes/stepTrackingRoutes.js";
...
app.use("/api/steps", stepTrackingRoutes);
...
server.listen(PORT, () =>
  console.log(
    `Server running on port ${PORT}, frontend origin: ${FRONTEND_URL}`
  )
);
